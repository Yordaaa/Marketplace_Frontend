...
export function ProductCard({ product }: ProductCardProps) {
    ...
    return (
        <div className="group shadow-md border p-2 rounded-md">
            ...
            <div>
                <button onClick={handleOnClick} className="w-full bg-purple-950 text-white py-1 rounded-md mt-3 hover:opacity-80">
                    Add to cart
                </button>
            </div>
        </div>
