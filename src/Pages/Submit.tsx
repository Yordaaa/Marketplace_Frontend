                ...
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form className=" space-y-6 ">
                        <div className="space-y-3">
                            <TextField label="Enter name" variant="standard" className="w-full " />
                            <TextField label="Enter email" variant="standard" className="w-full " />
                        </div>
                        <button className="mt-5 w-full text-white bg-purple-950 hover:opacity-90 font-medium rounded-lg  px-5 py-2.5 text-center">Submit</button>
