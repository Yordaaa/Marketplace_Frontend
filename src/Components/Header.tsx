...
function Header() {
  ...
  return (
    <div className="px-5 fixed top-0 left-0 right-0 z-50 bg-white shadow-md ">
      <img
          ...
          <div className="flex flex-1 justify-end gap-2 pr-3">
            <div>
              <Link to="/cart" className="flex justify-center items-center">
                ...
                <p className="text-white bg-red-600 absolute text-[12px]  rounded-full w-4 h-4 text-center ml-5 mb-5">
                  4
                </p>
              </Link>
            </div>
